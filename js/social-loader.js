// Social Links Loader
// Loads social media links from JSON config file

// Icon SVGs for different platforms
const icons = {
  github: `
...
async function loadSocialLinks() {
  try {
    ...
    const socialContainer = document.getElementById('social-links-grid');
    ...
    links.forEach(link => {
      ...
      const iconSvg = icons[link.icon] || icons.default;
...
// Load social links when DOM is ready
